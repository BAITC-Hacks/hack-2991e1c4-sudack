...
- Таймаут 8 с через `asyncio.wait_for` как общий дедлайн цепочки: быстро упавший провайдер (401) отдаёт всё оставшееся время следующему, а не последний провайдер ограничен 75% остатка, чтобы зависший основной не съел время запасного.
